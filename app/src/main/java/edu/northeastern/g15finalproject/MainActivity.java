...
//                    EmergencyContactDatabaseHelper db = new EmergencyContactDatabaseHelper(this);
//                    List<EmergencyContact> emergencyContacts = db.getAllEmergencyContacts();
//                    for (EmergencyContact emergencyContact : emergencyContacts) {
//                        System.out.println("Sending SMS to: " + emergencyContact.getPhoneNumber());
//                        SMSHelper.sendSMS(emergencyContact.getPhoneNumber(), "I need help. My location is: " + mapLocation.getLatitude() + ", " + mapLocation.getLongitude());
//                    }
//                });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RequestCode.BASIC_PERMISSION_MISSING_ACTIVITY.getValue()) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (data.hasExtra("all_permissions_granted")) {
                    System.out.println("Data received: " + data.getBooleanExtra("all_permissions_granted", false));
                } else {
